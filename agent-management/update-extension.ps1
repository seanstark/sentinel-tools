<#
 .DESCRIPTION
    This script will update Azure Virtual Machines and Azure Arc Machines to the desired or latest version of an extension.

 .PARAMETER machines
    Specify an object of machines from Get-AzVM or Get-AzConnectedMachine

 .PARAMETER linuxTargetVersion
    Specify the version of the extension to ugprade to for Linux. See https://learn.microsoft.com/azure/azure-monitor/agents/azure-monitor-agent-extension-versions for AMA

 .PARAMETER windowsTargetVersion
    Specify the version of the extension to ugprade to for Windows. See https://learn.microsoft.com/azure/azure-monitor/agents/azure-monitor-agent-extension-versions for AMA
 ...
 .PARAMETER extPublisherName
    Specify the Extension Publisher name. Defaults to Microsoft.Azure.Monitor. See https://learn.microsoft.com/azure/azure-arc/servers/manage-vm-extensions

 .PARAMETER windowsExtType
    Specify the Windows Extension Type name. Defaults to AzureMonitorWindowsAgent. See https://learn.microsoft.com/azure/azure-arc/servers/manage-vm-extensions

 .PARAMETER linuxExtType
    Specify the Linux Extension Type name. Defaults to AzureMonitorLinuxAgent. See https://learn.microsoft.com/azure/azure-arc/servers/manage-vm-extensions
